const CACHE_NAME = 'informatic-app-v15';
const ASSETS = [
  './',
  './index.html',
  './index.html?v=15',
  ...
  './forgot-password.html?v=15',
  './reset-password.html',
  './reset-password.html?v=15',
  './student-dashboard.html',
  './student-dashboard.html?v=15',
  './teacher-dashboard.html',
  './teacher-dashboard.html?v=15',
  './exam.html',
  './exam.html?v=15',
  './results.html',
  './results.html?v=15',
  './pseudocode.html',
  './pseudocode.html?v=15',
  './css/style.css',
  './css/style.css?v=15',
  './js/data.js',
  './js/data.js?v=15',
  ...
  './js/api.js?v=15',
  './js/games-adapter.js',
  './js/games-adapter.js?v=15',
  './js/perifericos_juego.js',
  './js/perifericos_juego.js?v=15',
  './js/webmaster_quiz_juego.js',
  './js/webmaster_quiz_juego.js?v=15',
  './imagenes/logo.png',
