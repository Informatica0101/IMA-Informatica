const CACHE_NAME = 'informatic-app-v16';
const ASSETS = [
  './',
  './index.html',
  './index.html?v=16',
  ...
  './forgot-password.html?v=16',
  './reset-password.html',
  './reset-password.html?v=16',
  './student-dashboard.html',
  './student-dashboard.html?v=16',
  './teacher-dashboard.html',
  './teacher-dashboard.html?v=16',
  './exam.html',
  './exam.html?v=16',
  './results.html',
  './results.html?v=16',
  './pseudocode.html',
  './pseudocode.html?v=16',
  './css/style.css',
  './css/style.css?v=16',
  './js/data.js',
  './js/data.js?v=16',
  ...
  './js/api.js?v=16',
  './js/games-adapter.js',
  './js/games-adapter.js?v=16',
  './js/perifericos_juego.js',
  './js/perifericos_juego.js?v=16',
  './js/webmaster_quiz_juego.js',
  './js/webmaster_quiz_juego.js?v=16',
  './imagenes/logo.png',
