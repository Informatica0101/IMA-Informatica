const CACHE_NAME = 'informatic-app-v19';
const ASSETS = [
  './',
  './index.html',
  './index.html?v=19',
  ...
  './forgot-password.html?v=19',
  './reset-password.html',
  './reset-password.html?v=19',
  './student-dashboard.html',
  './student-dashboard.html?v=19',
  './teacher-dashboard.html',
  './teacher-dashboard.html?v=19',
  './exam.html',
  './exam.html?v=19',
  './results.html',
  './results.html?v=19',
  './pseudocode.html',
  './pseudocode.html?v=19',
  './css/style.css',
  './css/style.css?v=19',
  './js/data.js',
  './js/data.js?v=19',
  ...
  './js/api.js?v=19',
  './js/games-adapter.js',
  './js/games-adapter.js?v=19',
  './js/perifericos_juego.js',
  './js/perifericos_juego.js?v=19',
  './js/webmaster_quiz_juego.js',
  './js/webmaster_quiz_juego.js?v=19',
  './imagenes/logo.png',
