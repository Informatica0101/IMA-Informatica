...
const ASSETS = [
  ...
  './forgot-password.html?v=22',
  './reset-password.html',
  './reset-password.html?v=22',
  './student-dashboard.html',
  './student-dashboard.html?v=22',
  './teacher-dashboard.html',
  './teacher-dashboard.html?v=22',
  './exam.html',
  './exam.html?v=22',
  './results.html',
  './results.html?v=22',
  './pseudocode.html',
  './pseudocode.html?v=22',
  './css/style.css',
  './css/style.css?v=22',
  './js/data.js',
  './js/data.js?v=22',
  ...
  './js/api.js?v=22',
  './js/games-adapter.js',
  './js/games-adapter.js?v=22',
  './js/perifericos_juego.js',
  './js/perifericos_juego.js?v=22',
  './js/webmaster_quiz_juego.js',
  './js/webmaster_quiz_juego.js?v=22',
  './imagenes/logo.png',
